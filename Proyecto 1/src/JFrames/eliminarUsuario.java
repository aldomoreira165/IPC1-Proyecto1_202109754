...
public static eliminarUsuario getInstancia(){
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        for (int i = 0; i <= crearUsuario.getInstancia().contador; i++) {
                if (crearUsuario.getInstancia().id[i].equals(txt_id.getText())) {
                    crearUsuario.getInstancia().nombre[i] = crearUsuario.getInstancia().nombre[i+1];
                    crearUsuario.getInstancia().apellido[i] = crearUsuario.getInstancia().apellido[i+1];
                    crearUsuario.getInstancia().user[i] = crearUsuario.getInstancia().user[i+1];
                    crearUsuario.getInstancia().rol[i] = crearUsuario.getInstancia().rol[i+1];
                    crearUsuario.getInstancia().password[i] = crearUsuario.getInstancia().password[i+1];
                    crearUsuario.getInstancia().id[i] = crearUsuario.getInstancia().id[i+1];
